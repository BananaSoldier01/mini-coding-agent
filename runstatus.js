...
const TRANSITIONS = {
  ...
  [RUN_STATUS.RUNNING]: [RUN_STATUS.VERIFYING, RUN_STATUS.WAITING_APPROVAL, RUN_STATUS.COMPLETED, RUN_STATUS.CANCELLED, RUN_STATUS.FAILED],
  [RUN_STATUS.WAITING_APPROVAL]: [RUN_STATUS.THINKING, RUN_STATUS.RUNNING, RUN_STATUS.VERIFYING, RUN_STATUS.CANCELLED, RUN_STATUS.FAILED],
