...
test('Skill: instruction priority constants exist', () => {
  ...
  assert.ok(SKILL_INSTRUCTION_PRIORITY.RUNTIME_POLICY > SKILL_INSTRUCTION_PRIORITY.SKILL_INSTRUCTION);
  assert.ok(SKILL_INSTRUCTION_PRIORITY.SKILL_INSTRUCTION > SKILL_INSTRUCTION_PRIORITY.USER_REQUEST);
});
